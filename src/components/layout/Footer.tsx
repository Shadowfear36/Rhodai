...
const socials = [
  {
    href: 'https://instagram.com/rhodai.ai',
    label: 'Instagram',
    icon: InstagramIcon,
  },
  {
    href: 'https://x.com/rhodai_',
    label: 'X / Twitter',
    icon: XIcon,
  },
  {
    href: 'https://linkedin.com/company/rhodai',
    label: 'LinkedIn',
    icon: LinkedInIcon,
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-slate-500 leading-relaxed max-w-xs">
              Smart websites. Intelligent integrations. Automated growth.
            </p>
          </div>
        ...
        <div className="mt-10 pt-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-xs text-slate-600">
            &copy; {currentYear} Rhodai. All rights reserved.
          </p>
